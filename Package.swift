...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "CalendarMCPCore",
            dependencies: [.product(name: "MCP", package: "swift-sdk")]
        ),
        .executableTarget(
            name: "apple-calendar-mcp",
            dependencies: ["CalendarMCPCore"],
            ...
            // embedded plist macOS denies calendar access without ever prompting.
            linkerSettings: [
                .unsafeFlags([
                    "-Xlinker", "-sectcreate",
                    "-Xlinker", "__TEXT",
        ...
        .testTarget(name: "CalendarMCPCoreTests", dependencies: ["CalendarMCPCore"]),
    ]
)
