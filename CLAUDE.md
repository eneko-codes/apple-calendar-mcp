...
Do not modify or delete existing calendar events. Test events in the owner's real calendar are live data: they need the owner's go-ahead under the rule below, and when allowed must be clearly named `TESTING: ...` and cleaned up when done.
